...
public class DashboardPelanggan extends JPanel {
    ...
    private void setupIdentityPanel() {
        ...
        identityPanel.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "Identitas Diri", 
        ...
        identityPanel.add(new JLabel("Nama Depan:"), gbc);
        ...
        identityPanel.add(new JLabel("Nama Belakang:"), gbc);
        gbc.gridx = 1; gbc.weightx = 1.0;
        ...
        identityPanel.add(new JLabel("Jenis Member:"), gbc);
        gbc.gridx = 1; gbc.weightx = 1.0;
        ...
        identityPanel.add(new JLabel("Poin:"), gbc);
        gbc.gridx = 1; gbc.weightx = 1.0;
        ...
        identityPanel.add(new JLabel("Tanggal Bergabung:"), gbc);
        gbc.gridx = 1; gbc.weightx = 1.0;
        ...
        btnHapusAkun = new JButton("Hapus Akun");
        ...
        btnAction = new JButton("Edit Profil");
    ...
    private void setupTopProductsPanel() {
        ...
        productsPanel.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createEtchedBorder(), "5 Barang Paling Sering Dibeli", 
                TitledBorder.LEFT, TitledBorder.TOP, new Font("Arial", Font.BOLD, 14)));

        tableModel = new DefaultTableModel(new String[]{"Nama Produk", "Kategori", "Total Jumlah", "Harga Satuan"}, 0) {
            @Override
    ...
    private void handleActionButton() {
        if (!isEditMode) {
            ...
            btnAction.setText("Simpan Perubahan");
            ...
            if (namaDepanBaru.isEmpty() || emailBaru.isEmpty() || passwordBaru.isEmpty()) {
                GUIHelper.showError(this, "Nama Depan, Email, dan Password harus diisi!");
                return;
            }
            ...
            if (currentUser != null) {
                ...
                if (success) {
                    GUIHelper.showInfo(this, "Identitas berhasil diperbarui!");
                    isEditMode = false;
                    setFieldsEditable(false);
                    ...
                    GUIHelper.showError(this, "Gagal memperbarui identitas di database.");
                }
            }
        }
    }
    ...
    private void handleHapusAkun() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            if (success) {
                GUIHelper.showInfo(this, "Akun Anda telah berhasil dihapus.");
                ...
                System.out.println("DEBUG: Akun terhapus, diarahkan kembali ke login screen.");
            } else {
                GUIHelper.showError(this, "Gagal menghapus akun dari database.");
            }
        }
    }
}